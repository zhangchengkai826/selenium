...
void Ssao::GetOffsetVectors(DirectX::XMFLOAT4 offsetVectors[14])
{
	std::copy(&mOffsetVectors[0], &mOffsetVectors[14], &offsetVectors[0]);
}
...
UINT Ssao::AmbientMapWidth()const
{
	return mRenderTargetWidth / 2;
}

UINT Ssao::AmbientMapHeight()const
{
